...
import com.raulzin.projetospring.enums.OrderStatus;
	...
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)     //anotações do JPA pra dizer que essa classe será uma tabela do bancodedados
	private Long id;
	
	//formatando como a data aparecerá no banco de dados
